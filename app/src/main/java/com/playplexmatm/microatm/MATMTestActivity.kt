...
import com.playplexmatm.util.hideKeyboard
...
class MATMTestActivity : AppCompatActivity(), AppApiCalls.OnAPICallCompleteListener {
    ...
    private lateinit var binding: ActivityMatmtestBinding
...
//    var m_id: String = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_matmtest)
        val gson = Gson()
...
//        }
        ...
        val fragmentHome = com.playplexmatm.activity.fragments.HomeFragment()
        supportFragmentManager.beginTransaction()
            .replace(R.id.contentFrame, fragmentHome)
            .commit()
        binding.navDrawerLayout.payments.setOnClickListener {
            binding.screenTitle.text = "Payment"
            val fragmentBill = com.playplexmatm.activity.fragments.HomeFragment()
            supportFragmentManager.beginTransaction()
                .replace(R.id.contentFrame, fragmentBill)
                .commit()
            binding.drawerLayout.closeDrawer(GravityCompat.START)
        }
        binding.navDrawerLayout.report.setOnClickListener {
            binding.screenTitle.text = "Report"
            val fragmentHome = com.playplexmatm.activity.fragments.ReportsFragment()
            supportFragmentManager.beginTransaction()
                .replace(R.id.contentFrame, fragmentHome)
                .commit()
            binding.drawerLayout.closeDrawer(GravityCompat.START)
        ...
        binding.navDrawerLayout.account.setOnClickListener {
            binding.screenTitle.text = "Account"
            val fragmentacc = com.playplexmatm.activity.fragments.AccountFragment()
            supportFragmentManager.beginTransaction()
                .replace(R.id.contentFrame, fragmentacc)
                .commit()
            binding.drawerLayout.closeDrawer(GravityCompat.START)
        }
...
//                        Log.wtf("chlo chlo",notifyObjJson.toString())
//                        binding.navDrawerLayout.terminalId.text = t_id
//                        binding.navDrawerLayout.merchantId.text = m_id

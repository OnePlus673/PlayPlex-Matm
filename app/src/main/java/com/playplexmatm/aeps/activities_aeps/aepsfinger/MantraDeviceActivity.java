package com.playplexmatm.aeps.activities_aeps.aepsfinger;
...
import com.playplexmatm.aeps.activities_aeps.BalanceCheckResponseActivity;
import com.playplexmatm.aeps.activities_aeps.MinistatementActivity;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.global.Verhoeff;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.maskedittext.MaskedEditText;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.model.DeviceInfo;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.model.Opts;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.model.PidData;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.model.PidOptions;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.model.uid.AuthReq;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.model.uid.AuthRes;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.model.uid.Meta;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.model.uid.Uses;
import com.playplexmatm.aeps.activities_aeps.aepsfinger.signer.XMLSigner;
                                ...
                                if (!result.contains("Resp errCode=\"720\"")) {
                                  ...
                                  // open(result);
                                   ...
                                   /* Bundle bundle = new Bundle();
                                    ...
                                    Toast.makeText(MantraDeviceActivity.this, "No Data Found..Please Try Again", Toast.LENGTH_SHORT).show();
    ...
    public void onAPICallCompleteListner(@Nullable Object item, @Nullable String flag, @NotNull String result) throws JSONException {
        if (flag.equals(AEPS_TRANSACTION)) {
            ...
            if (status.contains("true")) {
                ...
                Toast.makeText(this, aepsmessage, Toast.LENGTH_SHORT).show();
                if (transactionType.equalsIgnoreCase("ministatement")) {
                    ...
                    String balanceAmount = jsonObject.getJSONObject("result").getString("balanceAmount");
                    ...
                    newBundle.putString("balanceAmount",balanceAmount);
                    ...
                    String transactionRefNo = aepsResultObj.getString("transactionRefNo");
                    ...
                    if (transactionType.equalsIgnoreCase("balancecheck")) {
                        ...
                        beBunndle.putString("transactionRefNo", transactionRefNo);
                        ...
                        beBunndle.putString("bankName",bankName);
                        ...
                        finish();
                            ...
                            transactionType.equalsIgnoreCase("aadharpay")) {
//                        Bundle cwBunndle = new Bundle();
//                        cwBunndle.putString("aepsmessage", aepsmessage);
//                        cwBunndle.putString("transactionRefNo", transactionRefNo);
...
//        String url = "http://developer.uidai.gov.in/uidauthserver/";
    ...
    private void aepsTransaction(String cus_id, String txtPidData, String adhaarNumber,
                                 ...
                                 String type, String transactionAmount) {

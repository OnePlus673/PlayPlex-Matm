...
import kotlinx.android.synthetic.main.activity_dmt_commission_slab2.*
import kotlinx.android.synthetic.main.activity_dmt_commission_slab2.rvCommisionSlabReport
import kotlinx.android.synthetic.main.activity_dmt_commission_slab2.view.*
import org.json.JSONObject

class MicroAtmCommissionSlabActivity : AppCompatActivity() , PopupMenu.OnMenuItemClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dmt_commission_slab2)
        ...
        custToolbar.ivMore.setOnClickListener {
            val popup = PopupMenu(this@MicroAtmCommissionSlabActivity, ivMore)
            popup.setOnMenuItemClickListener(this@MicroAtmCommissionSlabActivity)
            popup.inflate(R.menu.menu_main)
            popup.show()
        }
        rvCommisionSlabReport.apply {

            layoutManager = LinearLayoutManager(this@MicroAtmCommissionSlabActivity)
    ...
    private fun commisionApi(cus_id: String, deviceId : String, deviceName : String,pin : String,
        ...
        if (AppCommonMethods(this).isNetworkAvailable) {
            ...
            mAPIcall.microatmcommisionSlab(cus_id)
        } else {

...
class AddEditCategoryActivity : AppCompatActivity(), View.OnClickListener {
        ...
        if (intent.extras != null) {
            ...
            if (mFrom == Constants.isEdit) {
                ...
                categoryModel = Gson().fromJson(
                    intent.getStringExtra(Constants.categoryModel), CategoryModel::class.java
                )
    ...
    private fun addListner() {
        ...
        edtCategoryName.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if (s!!.isNotEmpty()) {
                    edtSlug.setText(edtCategoryName.text.toString())
                } else {
                    edtSlug.setText(edtCategoryName.text.toString())
                }
            }
    ...
    private fun isValidate(): Boolean {
        var isValid = true
        if (edtCategoryName.text.toString().trim().isEmpty()) {
    ...
    private fun addCategory() {
        ...
        val call = apiInterface.addCategory(
            ...
            edtCategoryName.text.toString().trim().lowercase(),
            "",
            fileUrl
        )
        call.enqueue(object : Callback<JsonObject> {

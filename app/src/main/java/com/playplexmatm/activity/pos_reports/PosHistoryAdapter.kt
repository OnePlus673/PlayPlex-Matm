...
import com.playplexmatm.microatm.MicroAtmHistoryAdapter
...
class PosHistoryAdapter(
    context: Context?,
    rechargeHistoryModalList: ArrayList<PosHistoryModel>
) :
    RecyclerView.Adapter<PosHistoryAdapter.ViewHolder>() {
    private var rechargeHistoryModalList: List<PosHistoryModel>
    ...
    override fun onCreateViewHolder(
        ...
        val listItem: View =
            layoutInflater.inflate(R.layout.layout_list_pos_history, parent, false)
    ...
    override fun onBindViewHolder(
        ...
        val rechargeHistoryModal: PosHistoryModel =
    ...
    fun filterList(filterdNames: ArrayList<PosHistoryModel>) {

...
class PosCommissionSlabAdapter  (
    context: Context?,
    rechargeHistoryModalList: ArrayList<PosCommissionSlabModel>
) :
    RecyclerView.Adapter<PosCommissionSlabAdapter.ViewHolder>() {
    private var rechargeHistoryModalList: List<PosCommissionSlabModel>
    ...
    override fun onBindViewHolder(
        ...
        val rechargeHistoryModal: PosCommissionSlabModel =
...
//            ivStatus = itemView.findViewById(R.id.ivStatus)
    ...
    fun filterList(filterdNames: ArrayList<PosCommissionSlabModel>) {

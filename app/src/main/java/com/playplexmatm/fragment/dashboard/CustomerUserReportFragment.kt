...
import kotlinx.android.synthetic.main.fragment_customer_user_report.view.*
import kotlinx.android.synthetic.main.fragment_customer_user_report.view.edtSearch
...
class CustomerUserReportFragment : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        root = inflater.inflate(R.layout.fragment_customer_user_report, container, false)
        initUI(root)
        return root
    }
    ...
    private fun mNetworkCallUserReportAPI(newcurrentPage: Int) {
        ...
        val call = apiInterface.getUserReportCustomer("id desc","",offset,10)

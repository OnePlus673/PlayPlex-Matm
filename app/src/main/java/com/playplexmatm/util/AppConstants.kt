...
interface AppConstants {
    companion object {
        ...
        const val GET_LOGIN_DETAILS_API = "GET_LOGIN_DETAILS_API"
        const val UPDATE_LOGIN_DETAILS_API = "UPDATE_LOGIN_DETAILS_API"
        const val PINCODE_API = "PINCODE_API"
        const val IFSC_API = "IFSC_API"
        const val IFSC_ALL_API = "IFSC_ALL_API"
        const val ONBOARD_MATM_API = "ONBOARD_MATM_API"
        const val GET_MERCHANT_CAT_API = "GET_MERCHANT_CAT_API"
        const val FETCH_ONBOARDING_API = "FETCH_ONBOARDING_API"
        ...
        const val MATM_ONBOARDING_STATUS = "MATM_ONBOARDING_STATUS"

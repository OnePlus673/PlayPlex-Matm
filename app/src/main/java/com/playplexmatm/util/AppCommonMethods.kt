...
import com.playplexmatm.util.AppConstants.Companion.MOBILE_REGEX
import com.playplexmatm.util.AppConstants.Companion.PANCARD_REGEX
        ...
        //LOGOUT ON TOKEN EXPIRED
         fun logoutOnExpiredDialog(context: Context) {
            ...
            builder1.setPositiveButton(
                ...
                val intent = Intent(context, AepsLoginActivity::class.java)

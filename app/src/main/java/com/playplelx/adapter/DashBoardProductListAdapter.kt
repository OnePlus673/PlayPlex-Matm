...
class DashBoardProductListAdapter(
    val context: Context, val productArrayList: ArrayList<ProductModel>
) :
    RecyclerView.Adapter<DashBoardProductListAdapter.myViewholder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DashBoardProductListAdapter.myViewholder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.adp_dashboard_productlist, parent, false)
        return myViewholder(view)

    }

    override fun onBindViewHolder(holder: DashBoardProductListAdapter.myViewholder, position: Int) {
